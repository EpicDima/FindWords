...
public:
    ...
    BaseMenuItem(string* item, unsigned int languagesNumber) : languagesNumber(languagesNumber)
    {
    ...
    BaseMenuItem(const BaseMenuItem& b) : BaseMenuItem(b.item, b.languagesNumber) {}
