...
string MenuConstants::MenuItemsStrings[MenuItemsNumber][LanguagesNumber] = {{"1. Ввести таблицу букв", "1. Enter letter table"},
    ...
    {"4. Выбрать другой файл-словарь", "4. Select another dictionary file"}, 
    {"5. Выход", "5. Exit"}};
...
extern const string CombinedWordsSizeString[LanguagesNumber] = {"Количество совпавших слов, которые можно скомбинировать: ", "Number of matched words that can be combined:    "};
extern const string ColoredTablesString[LanguagesNumber] = {"Раскрашенные таблицы", "Colored tables"};
extern const string MatchedWordsString[LanguagesNumber] = {"Список совпавших слов (без повторений): ", "A list of matching words (without repetition): "};
extern const string CombinedWordsString[LanguagesNumber] = {"Список совпавших слов, которые можно скомбинировать (без повторений): ", "List of matching words that can be combined (without repetition): "};
extern const string EnterLinesString[LanguagesNumber] = {"Введите количество строк: ", "Enter the number of lines: "};
extern const string EnterColumnsString[LanguagesNumber] = {"Введите количество столбцов: ", "Enter the number of columns: "};
extern const string EnterLettersString[LanguagesNumber] = {"Вводите буквы (пробел является ячейкой без буквы)", "Enter letters (a space is a cell without a letter)"};
extern const string EnterMinLengthString[LanguagesNumber] = {"Введите минимальную длину слова: ", "Enter the minimum word length: "};
extern const string EnterMaxLengthString[LanguagesNumber] = {"Введите максимальную длину слова: ", "Enter the maximum word length: "};
...
extern const WORD attributesBackground[attributesLength] = {
	BACKGROUND_RED, 
	BACKGROUND_GREEN, 
	BACKGROUND_BLUE, 
...
extern const WORD attributesForeground[attributesLength] = {
	FOREGROUND_RED, 
	FOREGROUND_GREEN, 
	FOREGROUND_BLUE, 
